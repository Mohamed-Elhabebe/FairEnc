...
parser = argparse.ArgumentParser(description='Multi-attribute FairCLIP Training/Fine-Tuning')
...
if __name__ == '__main__':
    ...
    comet_experiment_tags = ['FairCLIP', 'Multi_Attributes', args.model_arch, str(args.seed)] + args.attributes
    ...
    for attribute in args.attributes:
        for i in range(groups_in_attrs[attr_to_idx[attribute]]):
            tmp_dataset = fair_vl_group_dataset(args.dataset_dir, preprocess, 
                    ...
                    attribute=attribute, thegroup=i)
